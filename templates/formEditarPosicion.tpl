...
<div class="box">
    <form action="{$accion}/{$posicion->id}" method="post" id="form-jugador" class="">
        ...
        <input type="text" name="nombre" placeholder="Nombre de la Posicion" value="{$posicion->nombre}" id="inputNombre" required > </input>
        <input class="buttonAceptar" type="submit" id="btn-agregarRow" value="Modificar Posicion"></input>
    </form>
